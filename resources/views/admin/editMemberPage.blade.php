...
<head>
    ...
    <title>IskoLib - Edit Member</title>
</head>
<body>
        ...
        <form action="{{ route('admin.members.suspend', $member->id) }}" method="POST" class="suspend-modal-card">
            ...
            <div class="modal-info-grid-box">
                ...
                <div class="info-grid-row">
                    ...
                    <span class="value">{{ $member->student_number ?? 'N/A' }}</span>
                </div>
                <div class="info-grid-row">
...
<style>
    * {
    ...
    .left-profile-sidebar-wrapper, 
    .right-history-tables-wrapper {
        display: flex;
        flex-direction: column;
        gap: 24px;
    }
    ...
    /* Right Side Sheets List Cards Containers */
    .directory-panel {
        padding: 24px;
    }
    ...
    /* Account Management Actions Footer Button */
    ...
    /* Modal Contextual Data Grid Overview */
    .modal-info-grid-box {
        background-color: #F9F6F0;
        border: 1px solid #EAE6DF;
        border-radius: 14px;
    ...
    /* Reason Entry Field Layout Block */
    .reason-entry-group {
        text-align: left;
        display: flex;
        flex-direction: column;
    ...
    /* Modal Bottom Actions Controllers */
