<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mt-6">
            <a href="{{ route('admin.login') }}" class="w-full flex justify-center items-center py-3 px-4 border border-indigo-200 rounded-lg shadow-sm text-sm font-bold text-indigo-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors">
